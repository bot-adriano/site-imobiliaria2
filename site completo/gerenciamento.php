...
<body>
    ...
    <nav">
        <div class="menu_ger">
            <button id="menua1" class="btmenu">casa</button>
            <div id="menub1" class="menub">
                <a href="novoimovel.php?num=<?php echo $n1 ?>" target="_self">novo</a>
                <a href="#" target="_self">editar</a>
                <a href="excluirimovel.php?num=<?php echo $n1 ?>" target="_self">excluir</a>
        ...
        <div class="menu_ger">
            <button id="menua3" class="btmenu"> imoveis</button>
            <div id="menub3" class="menub">
                <a href="#" target="_self">novo</a>
                <a href="#" target="_self">editar</a>
                <a href="#" target="_self">excluir</a>
                <a href="imoveis_tipo.php?num=<?php echo $n1 ?> " target="_self">tipo imovel</a>
                <!--temos q passar num e o php-->
            </div>
